    ...
    <div className="min-h-screen bg-white flex items-center justify-center p-4">
      ...
      >
        ...
        <motion.button
          ...
          whileHover={{ scale: 1.02 }}
          whileTap={{ scale: 0.98 }}
          className="w-full bg-white border border-gray-200 text-gray-700 py-3 rounded-xl font-medium hover:bg-gray-50 transition-colors disabled:opacity-50 flex items-center justify-center gap-2 cursor-pointer"
        >
        ...
        <p className="text-center mt-6 text-sm text-gray-600">
          ...
          <a href="/register" className="text-black font-medium hover:underline cursor-pointer">
            Sign up
          </a>
        </p>
      </motion.div>
